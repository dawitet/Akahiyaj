                ...
                Button(
                    onClick = {
                        if (userName.isBlank() || phoneNumber.isBlank()) {
                            // Show validation error with animation - using ErrorPreset instead of WarningPreset
                        ...
                        coroutineScope.launch {
                            ...
                            if (success) {
                                animationViewModel.showFormSubmissionSuccess()
                                onRegistrationSuccess()
                                onDismiss()
                            } else {
                                animationViewModel.showFormSubmissionError {
                                    // Retry logic
                                    isRegistering = false
                                }
                                isRegistering = false
                                ...
                                TextButton(
                                    onClick = {
                                        ...
                                        animationViewModel.showSuccess(
                                            title = "አባል ተወገደ!",
                                            subtitle = "${member.name} ከቡድን ተወግዷል።"
                                        )
            ...
            confirmButton = {
                Button(
                    onClick = {
                        ...
                        animationViewModel.showSuccess(
                            title = "ከቡድን ወጥተዋል!",
                            subtitle = "�� '$groupName' ቡድን በተሳካ ሁኔታ ወጥተዋል።",
