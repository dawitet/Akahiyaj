...
@HiltWorker
class LeaveGroupWorker @AssistedInject constructor(
            ...
            try {
                ...
                when (result) {
                    ...
                    is com.dawitf.akahidegn.core.result.Result.Error -> {
                        ...
                        logOperationError("LeaveGroupWorker", result.error, intelligentError)
                ...
                optimisticOperationsManager.markOperationFailed(operationId)
                uiEventManager.showError(intelligentError.userMessage)
                logOperationError("LeaveGroupWorker", e, intelligentError)
                Result.failure()
            }
        }
    }
    ...
    /**
     * Intelligent error handling for leave operations
     */
